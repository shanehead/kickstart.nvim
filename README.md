...
(so that you have your own copy that you can modify) and then install. You can
install it on your machine using the methods above.
...
# To copy from Astronvim

- Icons in one place with `get_icon` function
- keymaps (including which-key headings and icons)
